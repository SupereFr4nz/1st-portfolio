    ...
    <>
      ...
      <section id="skills" className="skills-section">
        ...
        <div className="skills-container">
          <div className="skill-card">
            {/* REMOVED 'public/' */}
            <img src="/mongodb11.png" alt="MongoDB" className="skill-img" />
            <p>MongoDB</p>
          </div>

          <div className="skill-card">
            <img src="/express21.jpg" alt="Express.js" className="skill-img" />
            <p>Express.js</p>
          </div>

          <div className="skill-card">
            <img src="/react1.png" alt="React" className="skill-img" />
            <p>React</p>
          </div>

          <div className="skill-card">
            <img src="/node1.png" alt="Node.js" className="skill-img" />
            <p>Node.js</p>
          </div>
        </div>
      </section>
      ...
      <section id="projects" className="projects">
        ...
        <div className="project-list">
          <div className="card">
            {/* REMOVED 'public/' */}
            <img src="/awesometodos1.png" alt="Awesometodos" className="project-img" />
            <h3>Awesometodos</h3>
          </div>

          <div className="card">
            <img src="/classe1.jpg" alt="Classe" className="project-img" />
            <h3>Classee</h3>
          </div>

          <div className="card">
            <img src="/webprofile1.png" alt="Web Portfolio" className="project-img" />
            <h3>Web Portfolio</h3>
          </div>
        </div>
      </section>
